...
if os.name == "nt":
    ...
    lib = CDLL("/home/admin/Downloads/yolov4-darknet-master/darknet-master/build/darknet/libdarknet.so", RTLD_GLOBAL)
...
def detect_image(net, meta, im, thresh=.5, hier_thresh=.5, nms=.45, debug= True):
    #import cv2
