...
if __name__ == '__main__':
    ...
    detect = Detect(metaPath=r'./cfg/target.data',
                    ...
                    weightPath=r'./backup/yolov4-target_best.weights',
    ...
    image = cv2.imread(r'/home/admin/PycharmProjects/yolov4-darknet-master/darknet-master/RdarData/雷达目标数据集/训练验证集/data/data_radar/images/val/radar_000000000018.jpg')
    print(type(image))
